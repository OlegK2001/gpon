      ...
      <header className="bg-card border-b border-border">
        <div className="flex items-center gap-3 px-6 py-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-lg font-bold">GPON Сетевой Симулятор</h1>
              <p className="text-xs text-muted-foreground">Профессиональное тестирование и анализ сетей</p>
            </div>
          </div>
        </div>
        <ControlPanel />
        ...
        <div className="w-80">
          <Tabs defaultValue="device" className="h-full flex flex-col">
            <TabsList className="grid w-full grid-cols-3 bg-card border-b border-border rounded-none">
              ...
              <TabsTrigger value="attacks">Атаки</TabsTrigger>
            </TabsList>
